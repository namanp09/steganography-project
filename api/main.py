...
def get_image_method(method: str, seed: Optional[int] = None):
    methods = {
...
def get_audio_method(method: str, seed: Optional[int] = None):
    methods = {
...
async def video_encode(
    ...
    info = stego_method.encode(cover_path, encrypted, out_path)
...
async def video_decode(
    ...
    stego_method = get_video_method(method, seed)
    encrypted = stego_method.decode(stego_path)
